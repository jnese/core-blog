...
## Project Scope
CORE project consists of three phases.

1. **Content & Convergent Evidence**
    + Validate the CORE passages and the ASR scoring.
2. **Calibration, Equating, Linking**
    + Equate and link across Grades 2 - 4 the passage parameters within and across the passages.
3. **Growth & Predictive Validity**
    + Compare the properties of CORE versus traditional ORF scores using (a) a longitudinal study design, and (b) predictive validity and classification accuracy of state test reading data and comprehension scores.
