...
figs2 <- tibble(
  name = fs::dir_ls(here::here("nopublish", "original"), regexp = "plot1.*gr2.*rds"),
...
figs2_g4 <- tibble(
  name = fs::dir_ls(here::here("nopublish", "original"), regexp = "ploterror.*gr4.*rds"),
...
figs <- tibble(
  name = fs::dir_ls(here::here("nopublish", "original"), regexp = "plot1.*gr3.*rds"),
  plot = map(name, ~read_rds(.) + theme(aspect.ratio=4/3))#coord_fixed(ratio = 4))
)
...
figs2 <- tibble(
  name = fs::dir_ls(here::here("nopublish", "original"), regexp = "ploterror.*gr3.*rds"),
  plot = map(name, ~read_rds(.) + theme(aspect.ratio = 4/3))#coord_fixed(ratio = 4))
)
...
figs4 <- tibble(
  name = fs::dir_ls(here::here("nopublish", "original"), regexp = "plot1.*gr4.*rds"),
  plot = map(name, ~read_rds(.) + theme(aspect.ratio=4/3))#coord_fixed(ratio = 4))
)
